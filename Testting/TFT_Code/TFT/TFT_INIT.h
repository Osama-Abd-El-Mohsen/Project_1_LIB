...
void TFT_MAIN_PAGE()
{
  ...
  MAIN_PAGE_BUTS[1] = myButtons.addButton(20, 83, 200, 30, "Button 2");
  MAIN_PAGE_BUTS[2] = myButtons.addButton(20, 146, 200, 30, "Button 3");
  MAIN_PAGE_BUTS[3] = myButtons.addButton(20, 209, 200, 30, "Button 4");
  MAIN_PAGE_BUTS[4] = myButtons.addButton(20, 272, 200, 30, "Button 5");
  MAIN_PAGE_BUTS[5] = myButtons.addButton(260, 20, 200, 30, "Button 6");
  MAIN_PAGE_BUTS[6] = myButtons.addButton(260, 83, 200, 30, "Button 7");
  MAIN_PAGE_BUTS[7] = myButtons.addButton(260, 146, 200, 30, "Button 8");
  MAIN_PAGE_BUTS[8] = myButtons.addButton(260, 209, 200, 30, "Button 9");
  MAIN_PAGE_BUTS[9] = myButtons.addButton(260, 272, 200, 30, "Button 10");
